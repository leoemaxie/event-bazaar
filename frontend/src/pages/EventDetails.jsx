    ...
    return (
        <div className="p-6 md:p-8 w-11/12 lg:w-3/4 m-auto max-w-6xl">
            ...
            <div className="flex flex-col my-8">
                <div className="flex">
                    <span className="mr-8">Host</span>
                    <p className="text-textPurple font-semibold pb-2">{getEventInfo.hostName}</p>
                </div>
                <div className="flex flex-col md:flex-row mt-4">
                    <div className="hidden rounded bg-gray mr-8 w-[40px] h-[40px] md:flex justify-center items-center"><img src={calender} alt=" calender icon" className="w-3/4" /></div>
