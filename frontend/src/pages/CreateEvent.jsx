                ...
                <form onSubmit={handleSubmitEvent}>
                    ...
                    <div className='md:flex'>
                        ...
                        <div className={style.labelContainer}>
                            <label htmlFor="volume" className={style.label}>Volume of Tickets*</label>
                            <input
                                type="number"
                                id='volume'
                                name='volume'
                    ...
                    <div className='flex justify-center text-white'>
                        <button type="submit" className='bg-blue px-8 py-3 mt-8 rounded-3xl font-semibold hover:bg-darkPurple' disabled={isLoading}>{isLoading ? 'loading...' : 'Register Event'}</button>
                    </div>
                </form>
            </div>
        </div>
