        ...
        <footer className='p-8 md:px-12 lg:px-20 bg-blackShade lg:py-16 text-white'>
            <div className='flex justify-between text-sm max-w-8xl m-auto flex-wrap'>
                <div className='max-w-xs mb-8'>
                    <img src={ticketLogo} alt="Event Bazaar" />
                    <p>Event Bazaar is a global decentralized self-service ticketing platform for live experiences that allows anyone to create, find and attend events that fuel their passions and enrich their lives.</p>
                </div>
                <div className='mb-8'>
                ...
                <div className='mb-8'>
                    <p className='text-lg font-semibold mb-4'>Event Bazaar</p>
                    <ul>
