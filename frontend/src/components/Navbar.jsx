        ...
        <nav className='bg-darkPurple px-8 md:px-12 lg:px-20 2xl:px-0'>
            <div className='flex justify-between items-center max-w-8xl m-auto h-20'>
                ...
                <div className='flex items-center'>
                    <button className='hidden md:block text-blue rounded-3xl border-blue border-[1px] px-5 py-2 mr-4' onClick={() => connectWallet()} disabled={walletAddress ? true : false}>{walletAddress ? `${shortenAddress(walletAddress)}` : 'Connect Wallet'}</button>
                    <Link to='/userProfile'>
